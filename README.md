# README
This [GitHub repository](https://github.com/ietf-chairs/chairs.ietf.org) is the content of the site https://chairs.ietf.org  Changes can be proposed here via pull requests. Please note the following guidance for submitters:
