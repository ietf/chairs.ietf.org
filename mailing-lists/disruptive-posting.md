...
* Are unrelated to the IETF, such as advertising and other unsolicited bulk e-mail (spam).
* Are related to the IETF but unrelated to the purpose of the list, as sometimes seen with excessive cross-posting.
* Contain unprofessional or uncivil commentary, or personal attacks.
* Contain confidential information (e.g. credentials, keys)
