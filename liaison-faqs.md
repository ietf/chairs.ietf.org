...
### When and Why do we need a formal liaison relationship?
...
- Provide access to their working documents or standards.  
- Provide input to ongoing work in other organizations  
- Participate in meetings in other organization

Also note that liaison statements can be sent and received without a formal relationship and liaison manager. In these cases please reach out to the IAB liaison coordinators ([laision-coordination@iab.org](mailto:laision-coordination@iab.org)) for further support.
...
### **Why** to Send a Liaison Statement from the IETF?

There can be different reasons to send a liaison statements to another SDO, such as

* To make the other SDOs aware of some ongoing work in the IETF that could be relevant to them.  
* To make the other SDOs aware of guidelines regarding the appropriate use of IETF-developed technologies.  
* To request information from the other SDO that is otherwise not available, e.g. to request access to documents or information about process and timelines, or to solicit Comments on a document of another organisation  
* To document a formal position from the IAB/IESG or IETF Working Groups that should be acknowledged by the other SDOs  
* To reply to formal requests from the other SDO, e.g., answer technical questions related to an RFC or working group document
...
### What consensus level is needed to send a LS?
...
* When there is liaison manager, inform the respective liaison manager who records in the datatracker  
* When there is no liaison manager, inform the IAB Liaison coordinators and the Liaison coordinators will work with the secretariat to get it recorded in the datatracker.

### Do We Need to Reply to all LS(s)?
