...
Found under `Settings->Message Acceptance`, the default value for this is "0" which disables any maximum size. You should consider setting a maximum of 10,000 (KB, or 10MB) to avoid large messages being sent.
